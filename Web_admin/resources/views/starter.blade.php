...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-orange navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ asset('layouts/index') }}" class="nav-link">Home</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="{{ asset('layouts/index') }}" class="brand-link">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ asset('layouts/index') }}" class="nav-link active">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href=" {{ asset('data/data_khachhang')}}" class="nav-link">
                  
                  <p>Dữ Liệu Bảng</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ asset('data/them_khachhang') }}" class="nav-link">
                  
                  <p>Thêm</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ asset('data/sua_khachhang') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href=" {{ asset('data/data_phim')}}" class="nav-link">
                  
                  <p>Dữ Liệu Bảng</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ asset('data/them_phim') }}" class="nav-link">
                  
                  <p>Thêm</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ asset('data/sua_phim') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href=" {{ asset('data/data_rap')}}" class="nav-link">
                  
                  <p>Dữ Liệu Bảng</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ asset('data/them_rap') }}" class="nav-link">
                  
                  <p>Thêm</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ asset('data/sua_rap') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href=" {{ asset('data/data_lichchieu')}}" class="nav-link">
                  
                  <p>Dữ Liệu Bảng</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ asset('data/them_lichchieu') }}" class="nav-link">
                  
                  <p>Thêm</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ asset('data/sua_lichchieu') }}" class="nav-link">
                  <p>Sửa</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href=" {{ asset('data/data_taikhoan')}}" class="nav-link">
                  
                  <p>Dữ Liệu Bảng</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ asset('data/them_taikhoan') }}" class="nav-link">
                  
                  <p>Thêm</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ asset('data/sua_taikhoan') }}" class="nav-link">
