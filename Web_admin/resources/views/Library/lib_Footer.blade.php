...
<script src="{{ URL::to('public/plugins/fullcalendar/main.min.js')}}"></script>
<script src="{{ URL::to('public/plugins/fullcalendar-daygrid/main.min.js')}}"></script>
<script src="{{ URL::to('public/plugins/fullcalendar-timegrid/main.min.js')}}"></script>
<script src="{{ URL::to('public/plugins/fullcalendar-interaction/main.min.js')}}"></script>
<script src="{{ URL::to('public/plugins/fullcalendar-bootstrap/main.min.js')}}"></script>
<script>
  $(function () {
